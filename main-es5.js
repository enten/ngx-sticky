...
var NGX_BASE_INTERSECTION_CONFIG_SCHEMA = {
    disabled: {
...
var NgxInViewportDirective = /** @class */ (function () {
    function NgxInViewportDirective(rootContainer, stickyContainer, elementRef, ngZone, _win) {
    ...
    Object.defineProperty(NgxInViewportDirective.prototype, "container", {
        get: function () {
    ...
    Object.defineProperty(NgxInViewportDirective.prototype, "config", {
        get: function () {
    ...
    Object.defineProperty(NgxInViewportDirective.prototype, "disabled", {
        get: function () {
    ...
    Object.defineProperty(NgxInViewportDirective.prototype, "state", {
        /**
    ...
    NgxInViewportDirective.prototype.ngOnChanges = function (changes) {
        this.config$.nextChanges(changes);
    };
    NgxInViewportDirective.prototype.ngAfterViewInit = function () {
    ...
    NgxInViewportDirective.prototype.beforeRefresh = function (fastUpdate) {
        if (!fastUpdate) {
            this._intersection = null;
        }
    };
    NgxInViewportDirective.prototype.disableIntersection = function () {
        this.config$.nextKeyValue('disabled', true, { skipCoercion: true });
    };
    NgxInViewportDirective.prototype.enableIntersection = function () {
        this.config$.nextKeyValue('disabled', false, { skipCoercion: true });
    };
    NgxInViewportDirective.prototype.getIntersection = function () {
        if (!this._intersection) {
            this._intersection = this._computeIntersection();
        }
        return this._intersection;
    };
    NgxInViewportDirective.prototype.refresh = function (computation) {
        this._refresh$.next(computation);
    };
    NgxInViewportDirective.prototype.update = function (fastUpdate) {
        this.container.updateStickies(fastUpdate);
    };
    NgxInViewportDirective.prototype._computeIntersection = function () {
        var config = this.config$.getValue();
        var elementRect = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_9__["getElementAbsoluteRect"])(this.elementRef.nativeElement);
        return {
     ...
     */
    NgxInViewportDirective.prototype._createMonitoringObservable = function () {
     ...
     */
    NgxInViewportDirective.prototype._destroyMonitoring = function () {
        if (this._monitoring) {
     ...
     */
    NgxInViewportDirective.prototype._initMonitoring = function () {
        var _this = this;
        if (!this._win || this._monitoring) {
            return;
        }
        this.ngZone.runOutsideAngular(function () {
            var handleRefreshSubscription = _this._refresh$
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this._destroyed$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(0, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"], { leading: true, trailing: true }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (computation) {
                _this._refreshIntersection(computation);
            });
            var triggerUpdateSubscription = _this._createMonitoringObservable()
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this._destroyed$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (fastUpdate) {
                _this.update(fastUpdate);
            });
            _this._monitoring = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subscription"]();
            _this._monitoring.add(handleRefreshSubscription);
            _this._monitoring.add(triggerUpdateSubscription);
        });
    };
    /**
     ...
     */
    NgxInViewportDirective.prototype._refreshIntersection = function (computation) {
        var _this = this;
        ...
        if (computation.state !== this._intersectionState) {
            this.ngZone.run(function () {
                _this._intersectionState = computation.state;
                _this.intersectionState.next(computation.state);
            });
        }
        var oldEntry = this._intersectionCrossed;
        var newEntry = computation;
        var oldRatio = oldEntry ? oldEntry.ratio : 0;
        var newRatio = newEntry.ratio;
        // ignore when ratios are unchanged
        if (oldEntry && oldRatio === newRatio) {
            return;
        }
        var crossedThreshold = Object(_utils_intersection__WEBPACK_IMPORTED_MODULE_10__["getCrossedThreshold"])(computation.snap.intersection.thresholds, oldRatio, newRatio);
        ...
        this.ngZone.run(function () {
            _this._intersectionThreshold = crossedThreshold;
            _this.intersectionThreshold.next(crossedThreshold);
 ...
 */
var NgxStickyBaseBoundaryController = /** @class */ (function () {
    function NgxStickyBaseBoundaryController() {
    }
    NgxStickyBaseBoundaryController.prototype.updateStickies = function (fastUpdate) {
        this.container.updateStickies(fastUpdate);
    };
    return NgxStickyBaseBoundaryController;
}());
 ...
 */
var NgxStickyBaseContainerController = /** @class */ (function () {
    function NgxStickyBaseContainerController() {
        this.boundaries = [];
        this.containers = [];
        this.intersections = [];
        this.stickies = [];
    ...
    NgxStickyBaseContainerController.prototype.disableAllStickies = function () {
    ...
    NgxStickyBaseContainerController.prototype.enableAllStickies = function () {
        this.enableStickies();
        for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
            var container = _a[_i];
    ...
    NgxStickyBaseContainerController.prototype.getStickedOffset = function (position, viewportTop) {
        var container = this.getContainer();
        var viewportHeight = this.getViewportHeight();
        var stickies = [];
        for (var _i = 0, _a = this.stickies; _i < _a.length; _i++) {
            var stickyController = _a[_i];
    ...
    NgxStickyBaseContainerController.prototype.fixViewportTop = function (viewportTop, userOffsetTop) {
        // const container = this.getContainer();
        var viewportTopOffsetless = viewportTop - (userOffsetTop || 0);
        var stickedOffsetTop = this.getStickedOffset('top', viewportTopOffsetless);
        var viewportTopFixed = viewportTopOffsetless /* - container.offsetTop*/ - stickedOffsetTop;
        if (this.containerParent) {
            viewportTopFixed -= this.getContainer().top;
        }
        return viewportTopFixed;
    };
    NgxStickyBaseContainerController.prototype.registerContainer = function (containerController) {
        Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["addEntry"])(this.containers, containerController);
    };
    NgxStickyBaseContainerController.prototype.registerBoundary = function (boundaryController) {
        Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["addEntry"])(this.boundaries, boundaryController);
    };
    NgxStickyBaseContainerController.prototype.registerIntersection = function (intersectionController) {
        var intersectionIndex = Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["addEntry"])(this.intersections, intersectionController);
        if (intersectionIndex !== -1) {
            this._intersectionSnaps[intersectionIndex] = null;
            this._intersectionComputations[intersectionIndex] = null;
        }
    };
    NgxStickyBaseContainerController.prototype.registerSticky = function (stickyController) {
        var stickyIndex = Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["addEntry"])(this.stickies, stickyController);
        if (stickyIndex !== -1) {
            this._stickySnaps[stickyIndex] = null;
            this._stickyComputations[stickyIndex] = null;
        }
    };
    NgxStickyBaseContainerController.prototype.updateAllStickies = function (fastUpdate) {
        this.updateStickies(fastUpdate);
        for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
            var containerController = _a[_i];
            containerController.updateAllStickies(fastUpdate);
        }
    };
    NgxStickyBaseContainerController.prototype.updateStickies = function (fastUpdate) {
        ...
        if (!fastUpdate) {
            ...
            for (var _i = 0, _a = this.boundaries; _i < _a.length; _i++) {
                var boundaryController = _a[_i];
                boundaryController.beforeRefresh(fastUpdate);
            }
            for (var stickyIndex = 0; stickyIndex < this.stickies.length; ++stickyIndex) {
                this._stickyComputations[stickyIndex] = null;
                this._stickySnaps[stickyIndex] = null;
                this.stickies[stickyIndex].beforeRefresh(fastUpdate);
            }
            for (var intersectionIndex = 0; intersectionIndex < this.intersections.length; ++intersectionIndex) {
                this._intersectionComputations[intersectionIndex] = null;
                this._intersectionSnaps[intersectionIndex] = null;
        ...
        var viewportTop = this.getViewportTop() + this.getContainer().top;
        var stickies;
        // refresh stickies
        for (var stickyIndex = 0; stickyIndex < this.stickies.length; ++stickyIndex) {
            var stickyController = this.stickies[stickyIndex];
            var stickyComputation = this._stickyComputations[stickyIndex];
            if (!stickyComputation || stickyComputation.viewportTop !== viewportTop) {
                var stickySnap = this._stickySnaps[stickyIndex];
                if (!stickySnap) {
                    if (!stickies) {
                        stickies = [];
                        for (var _b = 0, _c = this.stickies; _b < _c.length; _b++) {
                            var _stickyController = _c[_b];
        ...
        for (var intersectionIndex = 0; intersectionIndex < this.intersections.length; ++intersectionIndex) {
            var intersectionController = this.intersections[intersectionIndex];
            var intersectionComputation = this._intersectionComputations[intersectionIndex];
            if (!intersectionComputation || intersectionComputation.viewportTop !== viewportTop) {
                var intersectionSnap = this._intersectionSnaps[intersectionIndex];
                if (!intersectionSnap) {
                    if (!stickies) {
                        stickies = [];
                        for (var _d = 0, _e = this.stickies; _d < _e.length; _d++) {
                            var _stickyController = _e[_d];
                            stickies.push(_stickyController.getSticky());
                        }
                    }
                    var intersection = intersectionController.getIntersection();
    ...
    NgxStickyBaseContainerController.prototype.unregisterContainer = function (container) {
        Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["deleteEntry"])(this.containers, container);
    };
    NgxStickyBaseContainerController.prototype.unregisterBoundary = function (boundary) {
        Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["deleteEntry"])(this.boundaries, boundary);
    };
    NgxStickyBaseContainerController.prototype.unregisterIntersection = function (intersectionController) {
        var intersectionIndex = Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["deleteEntry"])(this.intersections, intersectionController);
        if (intersectionIndex !== -1) {
            this._intersectionSnaps[intersectionIndex] = null;
            this._intersectionComputations[intersectionIndex] = null;
        }
    };
    NgxStickyBaseContainerController.prototype.unregisterSticky = function (sticky) {
        var stickyIndex = Object(_utils_collections__WEBPACK_IMPORTED_MODULE_0__["deleteEntry"])(this.stickies, sticky);
        if (stickyIndex !== -1) {
            this._stickySnaps[stickyIndex] = null;
            this._stickyComputations[stickyIndex] = null;
        }
    };
    return NgxStickyBaseContainerController;
}());
...
var NGX_STICKY_BASE_CONTAINER_CONFIG_SCHEMA = {
    disabled: {
...
var NgxStickyBaseContainerDirective = /** @class */ (function (_super) {
    ...
    function NgxStickyBaseContainerDirective(containerParent, stickyEngine, ngZone, _win) {
        ...
        _this._win = _win;
        /** Inputs config */
        _this.config$ = new _utils_config_subject__WEBPACK_IMPORTED_MODULE_6__["ConfigSubject"](NGX_STICKY_BASE_CONTAINER_CONFIG_SCHEMA);
        /** Emits when the service is destroyed. */
        _this.destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        /** Emits when updateStickies() is called */
        _this._updateStickies$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        if (_this.containerParent) {
            _this.containerParent.registerContainer(_this);
        }
        _this._getDocumentHeight = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getDocumentHeightFactory"])(_this._win);
        _this._getDocumentWidth = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getDocumentWidthFactory"])(_this._win);
        return _this;
    }
    Object.defineProperty(NgxStickyBaseContainerDirective.prototype, "config", {
        get: function () {
            return this.config$.getValue();
        },
        enumerable: true,
    ...
    Object.defineProperty(NgxStickyBaseContainerDirective.prototype, "disabled", {
        get: function () {
            return this.config.disabled;
        },
        enumerable: true,
    ...
    NgxStickyBaseContainerDirective.prototype.ngOnChanges = function (changes) {
        this.config$.nextChanges(changes);
    };
    NgxStickyBaseContainerDirective.prototype.ngOnDestroy = function () {
        if (this.containerParent) {
    ...
    NgxStickyBaseContainerDirective.prototype.beforeRefresh = function (fastUpdate) {
        if (!fastUpdate) {
            this._container = null;
        }
    };
    NgxStickyBaseContainerDirective.prototype.createScrollPlan = function (target, userOffsetTop) {
        var scrollPlan = [];
        if (!this._win) {
            return scrollPlan;
        }
        var scrollToFn = this.element
            ? this.element.scrollTo.bind(this.element)
            : this._win.scrollTo.bind(this._win);
        var containsElement = false;
        if (typeof target === 'string') {
            var elementAsNumber = parseFloat(target);
        ...
        if (typeof target === 'number' && !isNaN(target)) {
            var elementTop = this.fixViewportTop(target, userOffsetTop);
            scrollPlan.push({
        ...
        var targetContainer;
        var targetContainerScrollPlan;
        for (var _i = 0, _a = this.containers; _i < _a.length; _i++) {
            var containerController = _a[_i];
            var containerScrollPlan = containerController.createScrollPlan(target, userOffsetTop);
        ...
        var containerScrollable = !this.element || Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["isElementScrollableY"])(this._win, this.element);
        if (containerScrollable) {
            var targetLine = targetContainer
                ? targetContainer.getContainer()
                : Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getElementAbsoluteRect"])(target);
            var targetTopFixed = this.fixViewportTop(targetLine.top, userOffsetTop);
            scrollPlan.push({
                scrollToFn: scrollToFn,
        ...
        if (targetContainerScrollPlan) {
            scrollPlan.push.apply(scrollPlan, targetContainerScrollPlan);
        }
        return scrollPlan;
    };
    NgxStickyBaseContainerDirective.prototype.disableStickies = function () {
        this.config$.nextKeyValue('disabled', true, { skipCoercion: true });
    };
    NgxStickyBaseContainerDirective.prototype.enableStickies = function () {
        this.config$.nextKeyValue('disabled', false, { skipCoercion: true });
    };
    NgxStickyBaseContainerDirective.prototype.getContainer = function () {
        if (!this._container) {
            this._container = this._computeContainer();
        }
        return this._container;
    };
    NgxStickyBaseContainerDirective.prototype.getViewportHeight = function () {
        return Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getWindowViewportHeight"])(this._win);
    };
    NgxStickyBaseContainerDirective.prototype.getViewportLeft = function () {
        return Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getWindowViewportLeft"])(this._win);
    };
    NgxStickyBaseContainerDirective.prototype.getViewportTop = function () {
        return Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getWindowViewportTop"])(this._win);
    };
    NgxStickyBaseContainerDirective.prototype.registerSticky = function (sticky) {
        _super.prototype.registerSticky.call(this, sticky);
        if (this.stickies.length) {
            this._initMonitoring();
        }
    };
    NgxStickyBaseContainerDirective.prototype.unregisterSticky = function (sticky) {
        _super.prototype.unregisterSticky.call(this, sticky);
        if (!this.stickies.length) {
            this._destroyMonitoring();
        }
    };
    NgxStickyBaseContainerDirective.prototype.scrollToTop = function (target, userOffsetTop) {
        var scrollPlan = this.createScrollPlan(target, userOffsetTop);
        for (var _i = 0, scrollPlan_1 = scrollPlan; _i < scrollPlan_1.length; _i++) {
            var scrollStep = scrollPlan_1[_i];
            scrollStep.scrollToFn(scrollStep.scrollToOptions);
        }
    };
    NgxStickyBaseContainerDirective.prototype.updateStickies = function (fastUpdate) {
        // intercept update stickies to throttle calls
        this._updateStickies$.next(fastUpdate);
    };
    NgxStickyBaseContainerDirective.prototype._computeContainer = function () {
        var config = this.config$.getValue();
        var containerRect = this.element ? Object(_utils_dom__WEBPACK_IMPORTED_MODULE_7__["getElementAbsoluteRect"])(this.element) : null;
        return {
    ...
    NgxStickyBaseContainerDirective.prototype._createMonitoringObservable = function () {
        if (!this._win) {
    ...
    NgxStickyBaseContainerDirective.prototype._createMonitoringInputsObservable = function () {
        return this.config$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounceTime"])(0), 
        // throttleTime(0, animationFrameScheduler),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mapTo"])(false));
    };
    NgxStickyBaseContainerDirective.prototype._createMonitoringScrollObservable = function () {
    ...
    NgxStickyBaseContainerDirective.prototype._createMonitoringWindowObservable = function () {
    ...
    NgxStickyBaseContainerDirective.prototype._destroyMonitoring = function () {
        if (this._monitoring) {
            this._monitoring.unsubscribe();
            this._monitoring = null;
        }
    };
    NgxStickyBaseContainerDirective.prototype._initMonitoring = function () {
        var _this = this;
        if (!this._win || this._monitoring) {
            return;
        }
        this.ngZone.runOutsideAngular(function () {
            _this._monitoring = _this._createMonitoringObservable()
            ...
            Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (fastUpdate) {
                _this._updateStickies(fastUpdate);
            });
 ...
 */
var NgxStickyBaseController = /** @class */ (function () {
    function NgxStickyBaseController() {
    }
    NgxStickyBaseController.prototype.update = function (fastUpdate) {
        // all stickies need to be updated when one of them changed
        this.container.updateStickies(fastUpdate);
    };
    return NgxStickyBaseController;
}());
...
var NGX_STICKY_BASE_BOUNDARY_CONFIG_SCHEMA = {
    unstacked: {
        aliasKey: 'stickyUnstacked',
        defaultValue: false,
...
var NgxStickyBoundaryDirective = /** @class */ (function (_super) {
    ...
    function NgxStickyBoundaryDirective(rootContainer, stickyContainer, elementRef, ngZone, _win) {
        ...
        _this.stickyContainer = stickyContainer;
        _this.elementRef = elementRef;
        _this.ngZone = ngZone;
        _this._win = _win;
        /** Inputs config */
        _this.config$ = new _utils_config_subject__WEBPACK_IMPORTED_MODULE_9__["ConfigSubject"](NGX_STICKY_BASE_BOUNDARY_CONFIG_SCHEMA);
        /** Emits when the component is destroyed. */
        _this._destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        // use root container when boundary isn't in container
        _this._container = stickyContainer || rootContainer;
        // register boundary in container for first update calls
        _this.container.registerBoundary(_this);
        return _this;
    }
    Object.defineProperty(NgxStickyBoundaryDirective.prototype, "config", {
        get: function () {
            return this.config$.getValue();
        },
        enumerable: true,
    ...
    Object.defineProperty(NgxStickyBoundaryDirective.prototype, "container", {
        get: function () {
            return this._container;
        },
        enumerable: true,
    ...
    NgxStickyBoundaryDirective.prototype.ngOnChanges = function (changes) {
        this.config$.nextChanges(changes);
    };
    NgxStickyBoundaryDirective.prototype.ngOnInit = function () {
        this._initMonitoring();
    };
    NgxStickyBoundaryDirective.prototype.ngOnDestroy = function () {
    ...
    NgxStickyBoundaryDirective.prototype.beforeRefresh = function (fastUpdate) {
        if (!fastUpdate) {
            this._boundary = null;
        }
    };
    NgxStickyBoundaryDirective.prototype.getBoundary = function () {
        if (!this._boundary) {
            this._boundary = this._computeBoundary();
        }
        return this._boundary;
    };
    NgxStickyBoundaryDirective.prototype._computeBoundary = function () {
        var boundary = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_10__["getElementAbsoluteRect"])(this.elementRef.nativeElement);
        if (this._win) {
            var boundaryStyle = this._win.getComputedStyle(this.elementRef.nativeElement);
            var paddingTop = parseFloat(boundaryStyle.paddingTop) || 0;
            var paddingBottom = parseFloat(boundaryStyle.paddingBottom) || 0;
    ...
    NgxStickyBoundaryDirective.prototype._createMonitoringObservable = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.config$, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"]).pipe(
        // throttleTime(0, animationFrameScheduler),
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mapTo"])(false));
    };
    NgxStickyBoundaryDirective.prototype._destroyMonitoring = function () {
        if (this._monitoring) {
            this._monitoring.unsubscribe();
            this._monitoring = null;
        }
    };
    NgxStickyBoundaryDirective.prototype._initMonitoring = function () {
        var _this = this;
        if (!this._win || this._monitoring) {
            return;
        }
        this.ngZone.runOutsideAngular(function () {
            _this._monitoring = _this._createMonitoringObservable()
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this._destroyed$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (fastUpdate) {
                _this.updateStickies(fastUpdate);
            });
        });
    };
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    return NgxStickyBoundaryDirective;
}(_sticky_base_boundary_controller__WEBPACK_IMPORTED_MODULE_4__["NgxStickyBaseBoundaryController"]));
...
var NgxStickyContainerDirective = /** @class */ (function (_super) {
    ...
    function NgxStickyContainerDirective(rootContainer, stickyContainerParent, stickyEngine, ngZone, elementRef, _win) {
        var _this = 
        // use root container when boundary isn't in container
        _super.call(this, stickyContainerParent || rootContainer, stickyEngine, ngZone, _win) || this;
        _this.rootContainer = rootContainer;
        _this.stickyContainerParent = stickyContainerParent;
        _this.stickyEngine = stickyEngine;
        _this.ngZone = ngZone;
        _this.elementRef = elementRef;
        _this._win = _win;
    ...
    NgxStickyContainerDirective_1 = NgxStickyContainerDirective;
    ...
    NgxStickyContainerDirective.prototype.getViewportHeight = function () {
        return this.element.offsetHeight;
    };
    NgxStickyContainerDirective.prototype.getViewportLeft = function () {
        return this.element.scrollLeft;
    };
    NgxStickyContainerDirective.prototype.getViewportTop = function () {
...
var NGX_STICKY_ENGINE_INTERCEPTION_STATE_MAP = {
...
var NgxStickyEngine = /** @class */ (function () {
     ...
     */
    NgxStickyEngine.prototype.computeStickyBoundary = function (container, boundary, sticky, directionDown, spot, viewportHeight) {
        var _a = boundary || container, boundaryHeight = _a.height, boundaryTop = _a.top, boundaryLeft = _a.left, boundaryWidth = _a.width;
        boundaryHeight = boundaryHeight || 0;
        boundaryTop = boundaryTop || 0;
        boundaryWidth = boundaryWidth || 0;
        boundaryLeft = boundaryLeft || 0;
        if (spot && spot.height) {
            var beforeSpot = sticky.top < spot.top;
            if (beforeSpot) {
                // when sticky direction is bottom and is before its spot
                if (directionDown) {
                    var spotPoint = spot.top - viewportHeight;
                ...
                if (!directionDown) {
                    var spotPoint = spot.top + spot.height + viewportHeight;
                    // disable sticky when is in same viewport height as its spot
                    if (spotPoint > sticky.top) {
                        boundaryHeight = 0;
                        boundaryTop = 0;
     ...
     */
    NgxStickyEngine.prototype.computeStickyStickedLine = function (boundary, sticky, positionBottom, directionDown, viewportHeight) {
        var stickedTop;
        var stickedHeight;
        if (positionBottom) {
            if (directionDown) {
     ...
     */
    NgxStickyEngine.prototype.computeStickySortPoint = function (sticky, positionBottom, directionDown, viewportHeight) {
        var sortPoint;
        if (positionBottom) {
     ...
     */
    NgxStickyEngine.prototype.determineIntersectionState = function (snap, viewportTop) {
        var enter = this.determineStickyState(snap.enter, viewportTop);
        var exit = this.determineStickyState(snap.exit, viewportTop);
        ...
        var stateKey = [enter.state, exit.state].join(',');
        var state = NGX_STICKY_ENGINE_INTERCEPTION_STATE_MAP[stateKey] || null;
        var viewportOffsetless = snap.viewportHeight - enter.offsetSticked - exit.offsetSticked;
        var maxHeightVisible = Math.min(snap.intersection.height, viewportOffsetless);
        var height = 0;
     ...
     */
    NgxStickyEngine.prototype.determineStickyState = function (snap, viewportTop) {
        var computation = {
            offsetSticked: 0,
            offsetStucked: 0,
            state: 'normal',
        ...
        var _stickyComputedState;
        // compute state for each sibling and stickyComputed in last
        for (var _i = 0, _a = snap.stickies; _i < _a.length; _i++) {
            var _stickyComputed = _a[_i];
            var boundaryOffset = _stickyComputed.directionDown
                ? _stickyComputed.boundary.offsetBottom
                : _stickyComputed.boundary.offsetTop;
            var _b = _stickyComputed.sticked, _stickedTop = _b.top, _stickedHeight = _b.height;
     ...
     */
    NgxStickyEngine.prototype.getStickedOffset = function (container, stickies, position, viewportHeight, viewportTop) {
        var positionBottom = Object(_sticky_helpers__WEBPACK_IMPORTED_MODULE_2__["isStickyPositionBottom"])(position);
        var maxStickyUnstackedHeight = 0;
        var stickedOffset = 0;
        for (var _i = 0, stickies_1 = stickies; _i < stickies_1.length; _i++) {
            ...
            var snap = this.snapSticky(container, stickies, _sticky, viewportHeight);
            // skip sticky when is disabled
            if (snap.sticky.disabled) {
                continue;
            }
            var computation = this.determineStickyState(snap, viewportTop);
            // add sticky height to offset top when state is sticked
            if (computation.state === 'sticked') {
                var _elementHeight = snap.stickyComputed.height;
     ...
     */
    NgxStickyEngine.prototype.snapIntersection = function (container, stickies, intersection, viewportHeight) {
        var disabled = intersection.disabled;
     ...
     * @returns Sticky snap
     */
    NgxStickyEngine.prototype.snapSticky = function (container, stickies, sticky, viewportHeight) {
        var boundariesMap = {};
        var directionDown = Object(_sticky_helpers__WEBPACK_IMPORTED_MODULE_2__["isStickyDirectionDown"])(sticky.direction);
        var positionBottom = Object(_sticky_helpers__WEBPACK_IMPORTED_MODULE_2__["isStickyPositionBottom"])(sticky.position);
        var stickyComputed = {
        ...
        for (var _stickyIndex = 0; _stickyIndex < stickies.length; ++_stickyIndex) {
            var _sticky = stickies[_stickyIndex];
            var _directionDown = void 0;
            var _positionBottom = void 0;
            var _stickyComputed = void 0;
            var _stickyComputedBoundaryRight = void 0;
            if (_sticky === sticky) {
            ...
            var boundaryKey = [_stickyComputed.boundary.top, _stickyComputed.boundary.height].join(',');
        ...
        stickiesComputed.sort(function (a, b) {
...
var NGX_STICKY_BASE_CONFIG_SCHEMA = {
    classes: {
...
var NgxStickyDirective = /** @class */ (function (_super) {
    ...
    ngZone, _win) {
        ...
        _this.rootContainer = rootContainer;
        _this.stickyContainer = stickyContainer;
        _this.stickyBoundary = stickyBoundary;
        _this.stickyParent = stickyParent;
        _this.elementRef = elementRef;
         ...
         */
        _this.stickyComputation = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        /**
         * Emit sticky state.
         */
        _this.stickyState = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        /** Inputs config */
        _this.config$ = new _utils_config_subject__WEBPACK_IMPORTED_MODULE_11__["ConfigSubject"](NGX_STICKY_BASE_CONFIG_SCHEMA);
        /** Emits when the component is destroyed. */
        _this._destroyed$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        /** Emits when refresh() is called */
        _this._refresh$ = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        /** Sticky element state which reflect last call of _refreshStickyElement() */
        _this._stickyElementState = null;
        /** Sticky element state which reflect last sticky state output */
        _this._stickyState = null;
        // use root container when sticky isn't in container
        _this._container = stickyContainer || rootContainer;
        // ensure sticky boundary is in same container
        _this._boundary = stickyBoundary && stickyBoundary.container === _this._container ? stickyBoundary : null;
        // register sticky in container only if isn't in another sticky
        if (!_this.stickyParent) {
            // register in parent container for first update calls
            _this.container.registerSticky(_this);
        }
        return _this;
    }
    NgxStickyDirective_1 = NgxStickyDirective;
    Object.defineProperty(NgxStickyDirective.prototype, "attrDataStickyState", {
        get: function () { return !this.stickyParent ? this.state : null; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "cssClassSticky", {
        get: function () { return !this.stickyParent && this.config.classes; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "cssClassStickyNormal", {
        get: function () { return this.cssClassSticky && this.state === 'normal'; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "cssClassStickySticked", {
        get: function () { return this.cssClassSticky && this.state === 'sticked'; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "cssClassStickyStucked", {
        get: function () { return this.cssClassSticky && this.state === 'stucked'; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "cssClassStickyDisabled", {
        get: function () { return this.cssClassSticky && this.disabled; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NgxStickyDirective.prototype, "boundary", {
    ...
    Object.defineProperty(NgxStickyDirective.prototype, "container", {
        get: function () {
            return this._container;
        },
        enumerable: true,
    ...
    Object.defineProperty(NgxStickyDirective.prototype, "config", {
        get: function () {
            return this.config$.getValue();
        },
        enumerable: true,
    ...
    Object.defineProperty(NgxStickyDirective.prototype, "disabled", {
        get: function () {
            return this.config.disabled;
        },
        enumerable: true,
    ...
    NgxStickyDirective.prototype.ngOnChanges = function (changes) {
        this.config$.nextChanges(changes);
    };
    ...
    NgxStickyDirective.prototype.beforeRefresh = function (fastUpdate) {
        if (!fastUpdate) {
            this._sticky = null;
        }
    };
    NgxStickyDirective.prototype.disableSticky = function () {
        this.config$.nextKeyValue('disabled', true, { skipCoercion: true });
    };
    NgxStickyDirective.prototype.enableSticky = function () {
        this.config$.nextKeyValue('disabled', false, { skipCoercion: true });
    };
    NgxStickyDirective.prototype.getSticky = function () {
        if (!this._sticky) {
            this._sticky = this._computeSticky();
        }
        return this._sticky;
    };
    NgxStickyDirective.prototype.refresh = function (computation) {
        this._refresh$.next(computation);
    };
    NgxStickyDirective.prototype._computeSticky = function () {
        ...
        var elementRect = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_12__["getElementAbsoluteRect"])(this.elementRef.nativeElement);
        var spotRect = config.spot ? Object(_utils_dom__WEBPACK_IMPORTED_MODULE_12__["getElementAbsoluteRect"])(config.spot) : null;
        if (config.height) {
     ...
     */
    NgxStickyDirective.prototype._createMonitoringObservable = function () {
     ...
     */
    NgxStickyDirective.prototype._destroyMonitoring = function () {
        if (this._monitoring) {
            this._monitoring.unsubscribe();
            this._monitoring = null;
        }
     ...
     */
    NgxStickyDirective.prototype._getStickyElementStyle = function (state, computation) {
        var win = this._win;
        if (!win || !state) {
            return null;
        }
        var ghost = this.config.spacer || this._spacerGenerated;
        var ghostParent = ghost.offsetParent;
        var ghostParentIsRootElement = ghostParent === win.document.body || ghostParent === win.document.documentElement;
        // when state is normal (computation isn't needed)
        if (state === 'normal') {
            var ghostRelativeRect = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_12__["getElementRelativeRect"])(win, ghost);
            var ghostStyle = win.getComputedStyle(ghost);
            var ghostBorderBox = ghostStyle.boxSizing === 'border-box';
            var elementWidth = ghostRelativeRect.width;
            if (!ghostBorderBox) {
                elementWidth +=
            ...
            var elementTop = ghostRelativeRect.top;
            var elementLeft = ghostRelativeRect.left;
            if (ghostParentIsRootElement) {
                if (this.container !== this.rootContainer) {
                    var ghostRect = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_12__["getElementAbsoluteRect"])(ghost);
                    var viewportTop = this.container.getViewportTop();
        ...
        var _a = computation.snap, container = _a.container, stickyComputed = _a.stickyComputed, viewportHeight = _a.viewportHeight;
        // when state is sticked
        if (state === 'sticked') {
            var positionBottom = stickyComputed.positionBottom;
            ...
            if (this.container !== this.rootContainer) {
                ...
                if (ghostParentIsRootElement) {
                    ...
                    var ghostParentRect = Object(_utils_dom__WEBPACK_IMPORTED_MODULE_12__["getElementAbsoluteRect"])(ghostParent);
        ...
        if (state === 'stucked') {
            ...
            if (ghostParentIsRootElement) {
                if (this.container !== this.rootContainer) {
                    ...
                    var relativeViewportTop = this.container.getViewportTop();
     ...
     */
    NgxStickyDirective.prototype._getStickyGhostStyle = function () {
        var stickySpacer = this.config.spacer || this._spacerGenerated;
        if (!this._win || !stickySpacer) {
            return null;
        }
        var element = this.elementRef.nativeElement;
        var elementStyle = this._win.getComputedStyle(element);
        var elementnBorderBox = elementStyle.boxSizing === 'border-box';
     ...
     * Hides sticky ghost.
     */
    NgxStickyDirective.prototype._hideStickyGhost = function () {
        var ghost = this.config.spacer || this._spacerGenerated;
        if (!ghost) {
            return;
        }
    ...
    NgxStickyDirective.prototype._initMonitoring = function () {
        ...
        this.ngZone.runOutsideAngular(function () {
            var handleRefreshSubscription = _this._refresh$
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this._destroyed$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["throttleTime"])(0, rxjs__WEBPACK_IMPORTED_MODULE_2__["animationFrameScheduler"], { leading: true, trailing: true }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (computation) {
                _this._refreshSticky(computation);
            });
            var triggerUpdateSubscription = _this._createMonitoringObservable()
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(_this._destroyed$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["share"])())
                .subscribe(function (fastUpdate) {
     ...
     */
    NgxStickyDirective.prototype._insertStickyGhostGenerated = function () {
        if (this._spacerGenerated) {
            return;
        }
        var element = this.elementRef.nativeElement;
        var ghost = this.renderer.createElement(element.tagName);
     ...
     */
    NgxStickyDirective.prototype._preventNestedStickyError = function () {
        if (!this.stickyParent) {
            return false;
        }
        var nestedStickyError = new Error('Nested sticky is not support. Sticky will not work.');
        var logLevel = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["isDevMode"])() ? 'error' : 'warn';
        var logLevelLogger = console[logLevel];
     ...
     * @param computation Sticky state computation
     */
    NgxStickyDirective.prototype._refreshSticky = function (computation) {
        var _this = this;
        if (
        ...
        this.ngZone.run(function () {
            _this._stickyState = computation.state;
            _this.stickyState.next(computation.state);
     ...
     */
    NgxStickyDirective.prototype._refreshStickyElement = function (state, computation) {
        if (!this._win) {
            return;
        }
        ...
        var elementStyle = this._getStickyElementStyle(state, computation);
     ...
     */
    NgxStickyDirective.prototype._refreshStickyGhost = function () {
        var ghost = this.config.spacer || this._spacerGenerated;
        var ghostStyle = this._getStickyGhostStyle();
     ...
     */
    NgxStickyDirective.prototype._restoreStickyElementStyle = function () {
     ...
     */
    NgxStickyDirective.prototype._saveStickyElementStyle = function () {
     ...
     * Shows sticky ghost.
     */
    NgxStickyDirective.prototype._showStickyGhost = function () {
...
}(_sticky_base_controller__WEBPACK_IMPORTED_MODULE_4__["NgxStickyBaseController"]));
...
function getStuckedPositionTop(computation) {
    var _a = computation.snap.stickyComputed, boundary = _a.boundary, directionDown = _a.directionDown, elementHeight = _a.height, positionBottom = _a.positionBottom;
...
var NGX_STICKY_WINDOW = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["InjectionToken"]('NGX_STICKY_WINDOW', {
    providedIn: 'root',
    factory: function () { return typeof window !== 'undefined' ? window : null; },
});
...
function addEntry(set, entry) {
    var entryIndex = set.indexOf(entry);
    if (entryIndex === -1) {
...
/* harmony import */ var _input_subject__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./input-subject */ "./projects/ngx-sticky/src/lib/utils/input-subject.ts");
...
var ConfigSubject = /** @class */ (function (_super) {
    ...
    function ConfigSubject(schema) {
        ...
        _this.changes$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        _this._pushChangesSubscription = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subscription"]();
        _this.inputs = {};
        _this._config = {};
        _this._configChanges = {};
        _this._aliases = {};
        var inputKeys = Object.keys(schema);
        var _loop_1 = function (inputKey) {
            var inputOptions = schema[inputKey];
            if (inputOptions.aliasKey) {
                this_1._aliases[inputOptions.aliasKey] = inputKey;
            }
            var input = new _input_subject__WEBPACK_IMPORTED_MODULE_2__["InputSubject"](inputOptions.defaultValue, inputOptions.coercion);
            this_1._config[inputKey] = inputOptions.defaultValue;
            this_1.inputs[inputKey] = input;
     ...
     */
    ConfigSubject.prototype.getValue = function () {
        return this._config;
    };
    /**
     * Returns key-value.
     ...
     * @returns key-value
     */
    ConfigSubject.prototype.getKeyValue = function (inputKey) {
     ...
     */
    ConfigSubject.prototype.next = function (partialConfig, options) {
        var inputKeys = Object.keys(partialConfig);
        for (var _i = 0, inputKeys_2 = inputKeys; _i < inputKeys_2.length; _i++) {
            var key = inputKeys_2[_i];
            var inputKey = (this._aliases[key] || key);
            if (inputKey in this.inputs) {
                var inputValue = partialConfig[key];
                var inputSubject = this.inputs[inputKey];
        ...
        if (this._configChanged) {
            ...
            _super.prototype.next.call(this, this._config);
        }
    };
    /**
     * Emit next key-value.
     ...
     * @param options Options to skip coercion
     */
    ConfigSubject.prototype.nextKeyValue = function (inputKey, value, options) {
        var _a;
        this.next((_a = {}, _a[inputKey] = value, _a), options);
    };
    /**
     ...
     */
    ConfigSubject.prototype.nextChanges = function (changes) {
        var changeKeys = Object.keys(changes);
        var config = {};
        for (var _i = 0, changeKeys_1 = changeKeys; _i < changeKeys_1.length; _i++) {
            var inputKey = changeKeys_1[_i];
...
function getDocumentHeightFactory(win) {
    ...
    var documentHeightGetters = [
        function () { return win.document.body.scrollHeight; },
        function () { return win.document.documentElement.scrollHeight; },
        function () { return win.document.body.offsetHeight; },
        function () { return win.document.documentElement.offsetHeight; },
        function () { return win.document.body.clientHeight; },
        function () { return win.document.documentElement.clientHeight; },
    ];
    var documentHeightGetter;
    var documentHeight = 0;
    for (var _i = 0, documentHeightGetters_1 = documentHeightGetters; _i < documentHeightGetters_1.length; _i++) {
        var _documentHeightGetter = documentHeightGetters_1[_i];
        var _documentHeight = _documentHeightGetter();
...
function getDocumentWidthFactory(win) {
    ...
    var documentWidthGetters = [
        function () { return win.document.body.scrollWidth; },
        function () { return win.document.documentElement.scrollWidth; },
        function () { return win.document.body.offsetWidth; },
        function () { return win.document.documentElement.offsetWidth; },
        function () { return win.document.body.clientWidth; },
        function () { return win.document.documentElement.clientWidth; },
    ];
    var documentWidthGetter = documentWidthGetters[0];
    var documentWidth = 0;
    for (var _i = 0, documentWidthGetters_1 = documentWidthGetters; _i < documentWidthGetters_1.length; _i++) {
        var _documentWidthGetter = documentWidthGetters_1[_i];
        var _documentWidth = _documentWidthGetter();
...
function getWindowViewportLeft(win) {
    ...
    var documentRect = win.document.documentElement.getBoundingClientRect();
...
function fromImageEvents(element) {
    ...
    var images$ = [];
    var addImage = function (target) { return images$.push(Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(target, 'load').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (event) { return ({ event: event, target: target }); })), Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(target, 'error').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (event) { return ({ event: event, target: target }); }))); };
    ...
    return rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"].apply(void 0, images$);
}
...
var InputSubject = /** @class */ (function (_super) {
    ...
    function InputSubject(defaultValue, coercion) {
        ...
        _this.coercion = coercion;
        /** Emit value changes */
        _this.change$ = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
        _this._firstChange = true;
     ...
     */
    InputSubject.prototype.getValue = function () {
        return this._value;
    };
    /**
     * Emit next value.
     ...
     * @param options Options to skip coercion
     */
    InputSubject.prototype.next = function (value, options) {
        ...
        if (value !== this._value) {
            var firstChange = this._firstChange;
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        var smallBreakpoint$ = Object(_projects_ngx_sticky_src_public_api__WEBPACK_IMPORTED_MODULE_2__["fromMediaQuery"])(this.win, '(min-width: 640px)');
